...
*/
	...
	****************************************/
	html.on('change', 'select.change-status', function(){
        var data = {statusId: $(this).children(":selected").attr("data-statusId"), orderId: $(this).children(":selected").attr("data-orderId")};
	...
	****************************************/
	html.on('click', 'button.change-status', function(){
        var data = {statusId: $(this).attr("data-statusId"), orderId: $(this).attr("data-orderId")};
	    ...
	    $.ajax({
            ...
            success: function(result) {
				...
				if(result.result.hasOwnProperty('number')){
					...
					productRow.find(".imei-result").addClass("success").text("Not reporterd").show();
	...
	****************************************/
    ...
    html.on('change', 'form.search select, form.search .multicheckbox input[type="checkbox"]', function () {
